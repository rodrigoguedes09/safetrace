...
# User info routes removed - SafeTrace uses session-based authentication without exposing user details
# Authentication is handled through JWT tokens or sessions, not API keys
